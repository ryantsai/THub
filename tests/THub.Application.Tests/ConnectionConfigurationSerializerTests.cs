...
public sealed class ConnectionConfigurationSerializerTests
{
    ...
    [Fact]
    public void SqlConfigurationRoundTripsWithoutCredentials()
    {
        ...
        Assert.Contains("\"integratedSecurity\":true", json, StringComparison.Ordinal);
    ...
    [InlineData("{\"schemaVersion\":1,\"server\":\"sql01\",\"database\":\"db\",\"integratedSecurity\":true,\"encrypt\":true,\"trustServerCertificate\":false,\"connectTimeoutSeconds\":15,\"commandTimeoutSeconds\":30,\"maximumBatchRows\":1000,\"password\":\"x\"}")]
