...
namespace THub.Infrastructure.Persistence.Migrations
{
    ...
    partial class THubDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("THub.Domain.Actions.TrustedAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("THub.Domain.Security.AccessRolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Permission = "workflow.target.upsert",
                            RoleId = new Guid("10000000-0000-0000-0000-000000000002")
                        },
                        new
                        {
                            Id = new Guid("11000000-0000-0000-0000-000000000011"),
                            Permission = "workflow.target.delete",
                            RoleId = new Guid("10000000-0000-0000-0000-000000000002")
                        });
                });
